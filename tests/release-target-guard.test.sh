#!/usr/bin/env bash
#
# release-target-guard.test.sh — tests for tools/release-target-guard.sh.
#
# Run:  bash tests/release-target-guard.test.sh
#
...
GUARD="${GUARD:-$here/../tools/release-target-guard.sh}"
